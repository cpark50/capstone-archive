...
import { addDoc, collection, getDocs, setDoc, doc, onSnapshot } from '@firebase/firestore';
...
export const Upload = () => {
                    ...
                    snapShot.docs.map(async (doc) => {
                        ...
                        subcollectionSnapshot.forEach((subDoc) => {
                            ...
                            if (studentData.id === user) {
                                setTa(studentData.associatedTAName)
                            }
                        });
                    })
                );
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            // Update the student's project status and projectID
            await setDoc(doc(firestore, `users/${ta}/students/${user}`), {
                projectID: docRef.id, // Assuming docRef.id is the projectID generated by Firestore
